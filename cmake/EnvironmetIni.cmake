...
if(DEFINED ENV{HALCONROOT})
    ...
    if(EXISTS ${HALCON_BIN_PATH} AND EXISTS ${HALCON_INCLUDE_PATH} AND EXISTS ${HALCON_LIB_PATH})
        ...
        message(FATAL_ERROR "HALCONROOT path is invalid. Required subdirectories 'bin', 'include', and 'lib' are missing.")
    endif()
else()
    set(INSTALL_HALCON "false") 
...
if(CUDA_FOUND)
    ...
    if(CUDA_VERSION VERSION_GREATER_EQUAL "12.0" AND CUDA_VERSION VERSION_LESS "13.0")
        set(TensorFindPath ${CMAKE_CURRENT_SOURCE_DIR}/ThirdLibrary/TensorRTs/cuda12/10.12)
        set(CUDA_IS_12 true)
    ...
    elseif(CUDA_VERSION VERSION_GREATER_EQUAL "11.0" AND CUDA_VERSION VERSION_LESS "12.0")
        set(TensorFindPath ${CMAKE_CURRENT_SOURCE_DIR}/ThirdLibrary/TensorRTs/cuda11/10.12)
        set(CUDA_IS_11 true)
