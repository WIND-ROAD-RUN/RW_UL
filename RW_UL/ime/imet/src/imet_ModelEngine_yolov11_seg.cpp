...
namespace rw {
	namespace imet {	
		ModelEngine_yolov11_seg::ModelEngine_yolov11_seg(std::string model_path, nvinfer1::ILogger& logger)
		{
		...
		void ModelEngine_yolov11_seg::preprocess(cv::Mat& image)
		{
		...
		void ModelEngine_yolov11_seg::draw(cv::Mat& image, const std::vector<DetectionSeg>& output)
		{
