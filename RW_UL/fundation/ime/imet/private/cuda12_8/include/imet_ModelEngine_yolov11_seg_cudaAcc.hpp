...
namespace rw
{
	namespace imet
	{
		class ModelEngine_yolov11_seg_cudaAcc
			: public ModelEngine
		{
		public:
			ModelEngine_yolov11_seg_cudaAcc(const std::string& modelPath, nvinfer1::ILogger& logger);
			ModelEngine_yolov11_seg_cudaAcc(const ModelEngineConfig& modelCfg, nvinfer1::ILogger& logger);
			~ModelEngine_yolov11_seg_cudaAcc() override;
		private:
