...
void GlobalStructData::buildImageProcessingModule(size_t num)
{
	...
	imageProcessingModule1->modelOnnxOOPath = onnxEngineOOPath1;
	...
	imageProcessingModule2->modelOnnxOOPath = onnxEngineOOPath2;
	...
	imageProcessingModule3->modelOnnxOOPath = onnxEngineOOPath3;
	...
	imageProcessingModule4->modelOnnxOOPath = onnxEngineOOPath4;
