#include"imet_ModelEngine_yolov11_obb_refactor.hpp"
...
namespace rw
{
	namespace imet
	{
		ModelEngine_Yolov11_Obb_Refactor::ModelEngine_Yolov11_Obb_Refactor(const std::string& modelPath,
			nvinfer1::ILogger& logger)
		{
			init(modelPath, logger);
		}

		ModelEngine_Yolov11_Obb_Refactor::~ModelEngine_Yolov11_Obb_Refactor()
		{
			for (int i = 0; i < 2; i++)
		...
		void ModelEngine_Yolov11_Obb_Refactor::init(std::string engine_path, nvinfer1::ILogger& logger)
		{
